#!/usr/bin/env python
"""Clean tenant schema and re-migrate."""
import os
import django
...
# Get a shop to get the schema name
...
# Drop auth/contenttypes from public
print(f"\nDropping auth and contenttypes from public schema...")
public_tables = [
...
print(f"\n" + "=" * 70)
print(f"Migrations completed for tenant schema '{schema_name}'")
print("=" * 70)
