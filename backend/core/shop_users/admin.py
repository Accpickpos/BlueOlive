...
class ShopUserAdmin(UserAdmin):
    ...
    """
    list_display = ['username', 'email', 'first_name', 'last_name', 'tenant_id', 'role', 'is_active', 'is_staff']
    list_filter = ['is_active', 'is_staff', 'role', 'tenant_id']  # Changed from 'tenant' to 'tenant_id'
