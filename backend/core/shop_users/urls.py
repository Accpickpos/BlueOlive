...
from .views import ShopUserViewSet, ProfileView, TenantTokenView, LogoutView, GetCSRFTokenView, UnifiedLoginView, SignupView
...
urlpatterns = [
    ...
    path('auth/token/refresh/', SimpleJWTTokenRefreshView.as_view(), name='token_refresh'),
