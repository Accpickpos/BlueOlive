...
from tenancy.utils import provision_tenant, register_tenant_connection
...
class ShopConfigurationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Accounting Period", {"fields": ("current_financial_year", "current_period")}),
    )
...
class SubscriptionPlanAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Pricing", {"fields": ("price", "setup_fee", "billing_period_days")}),
        ("Limits", {"fields": ("max_shops", "max_users", "max_invoices_per_month")}),
        ("Features", {"fields": ("features",)}),
        ("Settings", {"fields": ("is_active", "is_trial", "sort_order")}),
    )
...
class SubscriptionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Tenant & Plan", {"fields": ("tenant", "plan")}),
        ("Status", {"fields": ("status", "auto_renew", "cancelled_at")}),
        (
            "Dates",
            {
                "fields": (
        ...
        ("Usage", {"fields": ("invoices_this_period",)}),
        (
            "Gateway",
            {
    ...
    def extend_trials(self, request, queryset):
        ...
        for sub in queryset:
            if sub.status == "TRIAL":
                new_trial_end = (
                    sub.trial_end_date + timedelta(days=7)
...
class SubscriptionPaymentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Status", {"fields": ("status", "paid_at", "failed_at")}),
        (
            "Gateway",
            {
        ...
        ("Invoice", {"fields": ("description", "invoice_number")}),
    )
