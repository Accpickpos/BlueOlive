...
class PurchaseOrderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Status", {"fields": ("status", "is_back_order", "parent_order")}),
        (
            "Totals",
            {
                "fields": (
...
class PurchaseOrderReceiptAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Variance", {"fields": ("has_variance", "variance_notes")}),
        ("Integration", {"fields": ("creditor_grn",)}),
...
class BackOrderAdmin(admin.ModelAdmin):
    list_display = ("id", "original_order", "back_order", "created_date", "reason")
...
class PurchaseOrderTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Template Details", {"fields": ("template_name", "supplier", "description")}),
        (
            "Settings",
...
class PurchaseOrderTemplateLineAdmin(admin.ModelAdmin):
    list_display = ("template", "line_number", "stock_item", "default_quantity")
