    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                to="purchase_orders.purchaseorderreceipt",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="line_items",
                to="purchase_orders.purchaseordertemplate",
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="purchaseorder",
            index=models.Index(
                fields=["delivery_date"], name="purchase_or_deliver_4bacdd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="purchaseorder",
        ...
        migrations.AddIndex(
            model_name="purchaseorderline",
            index=models.Index(
                fields=["stock_code"], name="purchase_or_stock_c_dc1be0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="purchaseorderline",
            index=models.Index(
                fields=["is_fully_received"], name="purchase_or_is_full_d62b49_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="purchaseorderreceipt",
            index=models.Index(
                fields=["purchase_order", "receipt_date"],
                name="purchase_or_purchas_dfc123_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
