...
class StockFinderSalesOrderAdmin(admin.ModelAdmin):
    list_display = ['stockfinder_order_id', 'customer_name', 'vehicle_registration', 'status', 'order_date', 'total_amount']
    ...
    fields = [
        'stockfinder_order_id', 'order_number',
        'customer_name', 'customer_email', 'customer_phone',
        'vehicle_registration', 'vehicle_make', 'vehicle_model',
        'status', 'order_date', 'required_date', 'notes', 'fitment_center',
        'subtotal', 'tax_amount', 'total_amount',
        'local_job_card', 'local_invoice',
...
class StockFinderPurchaseOrderAdmin(admin.ModelAdmin):
    list_display = ['stockfinder_po_id', 'supplier_name', 'status', 'order_date', 'total_amount']
    list_filter = ['status', 'order_date']
    search_fields = ['stockfinder_po_id', 'supplier_name', 'local_po_number']
    inlines = [StockFinderPurchaseOrderLineInline]
    readonly_fields = ['created_at', 'updated_at']
    fields = [
        'stockfinder_po_id', 'local_po_number',
