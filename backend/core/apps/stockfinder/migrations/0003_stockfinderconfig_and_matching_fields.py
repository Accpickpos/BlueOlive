...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        (
            "stock_control",
            "0004_rename_idx_stockitem_is_active_stock_items_is_acti_025493_idx_and_more",
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Label for this configuration", max_length=100
                    ),
                ),
                ("base_url", models.URLField(help_text="Stockfinder API base URL")),
                (
                    "api_key",
                    tenancy.models.EncryptedCharField(blank=True, max_length=255),
                ),
                (
                    "api_secret",
                    tenancy.models.EncryptedCharField(blank=True, max_length=255),
                ...
                (
                    "webhook_secret",
                    tenancy.models.EncryptedCharField(
                        blank=True,
