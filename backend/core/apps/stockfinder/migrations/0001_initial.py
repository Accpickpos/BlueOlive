    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Enable this configuration"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True, help_text="Custom price field 1 name", max_length=50
                    ),
                ),
                (
                    "custom_price_field_2",
                    models.CharField(
                        blank=True, help_text="Custom price field 2 name", max_length=50
                    ),
                ),
                (
                    "custom_price_field_3",
                    models.CharField(
                        blank=True, help_text="Custom price field 3 name", max_length=50
                    ),
                ),
                (
                    "webhook_enabled",
                    models.BooleanField(
                        default=False, help_text="Enable webhook接收 for orders"
                    ),
                ),
                (
                    "webhook_secret",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "stockfinder_po_id",
                    models.CharField(
                        help_text="Stockfinder's PO ID", max_length=50, unique=True
                    ),
                ),
                (
                    "local_po_number",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="lines",
                        to="stockfinder.stockfinderpurchaseorder",
                    ),
                ),
                (
                    "updated_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        help_text="Stockfinder's order ID", max_length=50, unique=True
                    ),
                ),
                (
                    "order_number",
                    models.CharField(
                        blank=True, help_text="Local order number", max_length=50
                    ),
                ),
                ...
                (
                    "fitment_center",
                    models.CharField(
                        blank=True, help_text="Fitment center name/code", max_length=100
                    ),
                ),
                (
                    "subtotal",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "stock_code",
                    models.CharField(help_text="Item stock code", max_length=13),
                ),
                ("description", models.CharField(max_length=255)),
                (
                    "quantity",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="lines",
                        to="stockfinder.stockfindersalesorder",
                    ),
                ),
                (
                    "updated_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "request_data",
                    models.JSONField(
                        blank=True, default=dict, help_text="Request payload"
                    ),
                ),
                (
                    "response_data",
                    models.JSONField(
                        blank=True, default=dict, help_text="Response payload"
                    ),
                ),
                (
                    "config",
                    models.ForeignKey(
                        ...
                        to="stockfinder.stockfinderconfig",
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "stock_code",
                    models.CharField(
                        db_index=True, help_text="Item stock code/SKU", max_length=13
                    ),
                ),
                (
                    "description",
                ...
                (
                    "category",
                    models.CharField(
                        blank=True, help_text="Item category", max_length=100
                    ),
                ),
                (
                    "quantity_on_hand",
                ...
                (
                    "supplier_code",
                    models.CharField(
                        blank=True, help_text="Supplier's stock code", max_length=50
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["stock_code"], name="stockfinder_stock_c_260867_idx"
                    ),
                    models.Index(
                        fields=["description"], name="stockfinder_descrip_41f7d0_idx"
                    ),
                ],
            },
        ),
