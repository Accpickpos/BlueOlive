...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='expensecategorymonthlybalance',
            name='expense_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='monthly_balances', to='settings.expensecategory'),
        ),
        migrations.AddField(
            model_name='expensecategorymonthlybalance',
            name='updated_by',
        ...
        migrations.AddField(
            model_name='creditorinvoice',
            name='related_grn',
            field=models.ForeignKey(blank=True, help_text='Goods Received Note number if applicable', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='related_expense_invoices', to='creditors.goodsreceivednote'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='creditor',
            index=models.Index(fields=['sales_area'], name='creditors_sales_a_5edfbd_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='expensecategorymonthlybalance',
            index=models.Index(fields=['expense_category', 'year', 'month'], name='expense_cat_expense_d0d862_idx'),
        ),
        migrations.AddIndex(
            model_name='expensecategorymonthlybalance',
            index=models.Index(fields=['year', 'month'], name='expense_cat_year_cdd850_idx'),
        ),
        migrations.AlterUniqueTogether(
