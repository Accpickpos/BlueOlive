...
from .models import (
    Supplier, ExpenseCategory, CreditorTransaction, CreditorTransactionLine,
    OpenItemAllocation, RFC, RFCLineItem, SupplierMonthlyPurchase,
    ExpenseMonthlyTotal
)
from apps.settings.models import TaxCode, CreditTerms, SalesArea
...
class CreditorTransactionTests(TransactionTestCase):
    ...
    def test_supplier_balance_update_on_payment(self):
        ...
        payment = CreditorTransaction.objects.create(
...
class OpenItemAllocationTests(TransactionTestCase):
    ...
    def test_invoice_balance_update_on_allocation(self):
        ...
        self.assertEqual(
            ...
            initial_balance - Decimal('600.00')
        )
