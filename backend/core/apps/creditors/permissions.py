    ...
    def has_permission(self, request, view):
        ...
        return (
            ...
            or request.user.groups.filter(
                name__in=["creditors_admin", "creditors_manager", "admin"]
            ).exists()
        )
...
class CanReceiveGoods(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (
            ...
            or request.user.groups.filter(
                name__in=["creditors_admin", "creditors_manager", "purchasing", "admin"]
            ).exists()
        )
...
class CanPostCreditorInvoice(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (
            ...
            or request.user.groups.filter(
                name__in=["invoicing", "creditors_admin", "creditors_manager", "admin"]
            ).exists()
        )
...
class CanPostCreditorPayment(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (
            ...
            or request.user.groups.filter(
                name__in=["finance", "creditors_admin", "creditors_manager", "admin"]
            ).exists()
        )
