...
class MessageAttachmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'file', 'filename', 'content_type', 'file_size', 'url', 'uploaded_at']
...
class MessageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Message
        fields = ['id', 'conversation', 'sender', 'sender_name', 'content', 'is_read', 'created_at', 'attachments']
...
class ConversationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Conversation
        fields = ['id', 'title', 'participants', 'participants_detail', 'is_group', 'last_message', 'unread_count', 'created_at', 'updated_at']
        extra_kwargs = {
