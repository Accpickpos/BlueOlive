    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Salesman name or area name', max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_vat_number', models.CharField(blank=True, help_text='VAT registration number', max_length=50)),
                ('company_registration_number', models.CharField(blank=True, help_text='Company registration number', max_length=50)),
                ('ageing_periods', models.JSONField(default=list, help_text='Ageing periods in days [30, 60, 90, 120, 150, 180]')),
                ('current_financial_year', models.PositiveIntegerField(help_text='Current financial year (e.g., 2024)')),
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL)),
                ('default_tax_code', models.ForeignKey(help_text='Default tax code for new items', on_delete=django.db.models.deletion.PROTECT, related_name='system_configs', to='settings.taxcode')),
            ],
            options={
