# Generated by Django 5.2.7 on 2026-02-11 07:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('settings', '0002_alter_systemconfiguration_current_financial_year_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['key', 'status'], name='settings_ap_key_85f09f_idx'), models.Index(fields=['external_service'], name='settings_ap_externa_1c5236_idx'), models.Index(fields=['created_at'], name='settings_ap_created_4c2ec4_idx')],
            },
        ),
    ]
