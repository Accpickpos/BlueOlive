...
class SalesDepartmentAPITest(APITestCase):
    ...
    def test_list_departments(self):
        ...
        SalesDepartment.objects.create(number=1, name='Electronics', created_by=self.user)
    ...
    def test_deactivate_department(self):
        ...
        dept = SalesDepartment.objects.create(number=1, name='Electronics', created_by=self.user)
        response = self.client.post(f'/api/v1/settings/departments/{dept.id}/deactivate/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_active_only_filter(self):
        ...
        SalesDepartment.objects.create(number=1, name='Active', is_active=True, created_by=self.user)
        SalesDepartment.objects.create(number=2, name='Inactive', is_active=False, created_by=self.user)
...
class TaxCodeAPITest(APITestCase):
    ...
    def test_set_default_tax_code(self):
        ...
        # Set V0 as default
        response = self.client.post(f'/api/v1/settings/tax-codes/{tax2.id}/set_default/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
