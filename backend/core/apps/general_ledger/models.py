...
class GLMast(TimeStampedModel):
    ...
    name = models.CharField(max_length=30, help_text="Account Name")
    ...
    drorcr = models.CharField(
        max_length=1, choices=DEBIT_CREDIT_CHOICES, help_text="Debit or Credit"
    )
    ...
    period1 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 1 Balance"
    )
    period2 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 2 Balance"
    )
    period3 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 3 Balance"
    )
    period4 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 4 Balance"
    )
    period5 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 5 Balance"
    )
    period6 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 6 Balance"
    )
    period7 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 7 Balance"
    )
    period8 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 8 Balance"
    )
    period9 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 9 Balance"
    )
    period10 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 10 Balance"
    )
    period11 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 11 Balance"
    )
    period12 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 12 Balance"
    )
    period13 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Period 13 Balance"
    )

    # Budget Fields (12 months)
    budget1 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 1"
    )
    budget2 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 2"
    )
    budget3 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 3"
    )
    budget4 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 4"
    )
    budget5 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 5"
    )
    budget6 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 6"
    )
    budget7 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 7"
    )
    budget8 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 8"
    )
    budget9 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 9"
    )
    budget10 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 10"
    )
    budget11 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 11"
    )
    budget12 = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Budget Period 12"
    )
...
class GLTran(TimeStampedModel):
    ...
    type = models.CharField(
        max_length=1, choices=TRANSACTION_TYPE_CHOICES, help_text="Debit or Credit"
    )
    ...
    station = models.CharField(
        max_length=2, blank=True, help_text="Station/Workstation number"
    )

    reference = models.CharField(
        max_length=10, blank=True, help_text="Transaction reference code/voucher number"
    )

    # Description
    details = models.CharField(
        max_length=30, blank=True, help_text="Transaction details/description"
    )
...
class GLRep(TimeStampedModel):
    ...
    # Heading/Total Name
    name = models.CharField(max_length=30, help_text="Heading/Total name")
...
class GLBatch(TimeStampedModel):
    ...
    time = models.CharField(
        max_length=5, blank=True, help_text="Transaction time (HH:MM)"
    )
    ...
    station = models.CharField(
        max_length=2, blank=True, help_text="Station # (2 characters)"
    )

    # Transaction Reference
    reference = models.CharField(
        max_length=10, blank=True, help_text="Transaction reference"
    )

    # Transaction Details
    details = models.CharField(
        max_length=30, blank=True, help_text="Transaction Details"
    )

    # Amount
    amount = models.DecimalField(
        max_digits=12, decimal_places=2, help_text="Value (transaction amount)"
    )

    # Post Date/Time
    postdate = models.DateField(null=True, blank=True, help_text="Date posted")

    postime = models.CharField(
        max_length=5, blank=True, help_text="Time posted (HH:MM)"
    )
...
class GLStJnl(TimeStampedModel):
    ...
    # Transaction Details
    details = models.CharField(max_length=30, help_text="Transaction details")
    ...
    # Amount
    amount = models.DecimalField(
        max_digits=14, decimal_places=2, help_text="Value (transaction amount)"
    )
    ...
    descriptor = models.CharField(
        max_length=30, blank=True, help_text="Reference descriptor"
    )
...
class GLSpread(TimeStampedModel):
    ...
    ytddebit = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Year-to-date debit"
    )

    # Year-to-date Credit
    ytdcredit = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Year-to-date credit"
    )

    # Current Period Debit
    curdebit = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Current period debit"
    )

    # Current Period Credit
    curcredit = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Current period credit"
    )

    # Current Budget Debit
    curbuddeb = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Current budget debit"
    )

    # Current Budget Credit
    curbudcred = models.DecimalField(
        max_digits=14, decimal_places=2, default=0.00, help_text="Current budget credit"
    )
