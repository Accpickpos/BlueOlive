...
class GLMastAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Account Details", {"fields": ("accno", "name", "type", "drorcr", "repline")}),
        ("Balance Information", {"fields": ("balbfwd",)}),
        (
            "Period Balances",
            {
                "fields": (
...
class GLTranAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Transaction Details", {"fields": ("accno", "batchno", "date", "time")}),
        ("Classification", {"fields": ("type", "source", "station", "reference")}),
        ("Amount & Description", {"fields": ("amount", "details")}),
        (
            "Audit Information",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class GLStJnlAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Transaction Information", {"fields": ("drorcr", "amount")}),
        (
            "Scheduling",
...
class GLSpreadAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Account Details", {"fields": ("accno", "name")}),
        ("Year-to-Date Actuals", {"fields": ("ytddebit", "ytdcredit")}),
        ("Current Period Actuals", {"fields": ("curdebit", "curcredit")}),
        ("Current Period Budget", {"fields": ("curbuddeb", "curbudcred")}),
        ("Year-to-Date Budget", {"fields": ("ytdbuddeb", "ytdbudcred")}),
        (
            "Audit Information",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
