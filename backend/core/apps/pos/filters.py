...
from .models import CashSale, JobCard, Laybye, Quotation, Repair
...
class LaybyeFilter(django_filters.FilterSet):
    ...
    # Date range filters
    date_from = django_filters.DateFilter(field_name="laybye_date", lookup_expr="gte")
    date_to = django_filters.DateFilter(field_name="laybye_date", lookup_expr="lte")
