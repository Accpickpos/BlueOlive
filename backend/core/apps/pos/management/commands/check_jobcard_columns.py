            ...
            try:
                ...
                if result:
                    ...
                    if result[2] and result[2] < 25:
                        self.stdout.write(self.style.WARNING(f'Column max_length is {result[2]}, expected 25'))
                        ...
                        try:
                            ...
                            """)
                            self.stdout.write(self.style.SUCCESS('Successfully altered column to varchar(25)'))
                        except Exception as e:
                            self.stdout.write(self.style.ERROR(f'Error altering column: {e}'))
                    else:
                        self.stdout.write(self.style.SUCCESS('Column definition is correct'))
