...
class LaybyeViewSet(ShopFilterMixin, viewsets.ModelViewSet):
    """
    ViewSet for laybyes.
...
class QuotationViewSet(ShopFilterMixin, viewsets.ModelViewSet):
    """
...
class PayoutViewSet(ShopFilterMixin, viewsets.ModelViewSet):
...
class JobCardViewSet(ShopFilterMixin, viewsets.ModelViewSet):
...
class CashControlViewSet(ShopFilterMixin, viewsets.ReadOnlyModelViewSet):
    """
...
class ReceiptOnAccountViewSet(ShopFilterMixin, viewsets.ModelViewSet):
    """
...
class CreditNoteViewSet(ShopFilterMixin, viewsets.ModelViewSet):
    """
...
class TransactionQueryViewSet(ShopFilterMixin, viewsets.ModelViewSet):
    """
...
class InvoiceViewSet(ShopFilterMixin, viewsets.ModelViewSet):
    """
    ...
    def get_object(self):
        ...
        if pk and pk.isdigit():
            ...
            self.lookup_field = 'invoice_number'
            self.lookup_url_kwarg = 'pk'  # Use pk as the URL kwarg but lookup by invoice_number
            return super().get_object()
