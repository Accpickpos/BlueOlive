...
class PriceValidationService:
    ...
    @staticmethod
    def get_valid_prices_for_item(stock_code: str, quantity: Decimal = None, 
    ...
    @staticmethod
    def validate_unit_price(stock_code: str, unit_price: Decimal, 
                           price_level: int = 1, 
                           transaction_date: date = None) -> Tuple[bool, Optional[str], Dict]:
        """
        ...
        if special_deal:
            ...
            special_price = prices.get(f'special_selling_price_{price_level}', Decimal(0))
    ...
    @staticmethod
    def calculate_price_from_markup(stock_code: str, price_level: int = 1,
                                   transaction_date: date = None) -> Decimal:
        """
    ...
    @staticmethod
    def validate_line_item_price(stock_code: str, quantity: Decimal, 
                                unit_price: Decimal, discount_percent: Decimal = None,
                                price_level: int = 1,
                                transaction_date: date = None) -> Dict:
        """
    ...
    @staticmethod
    def log_price_variance(stock_code: str, unit_price: Decimal, 
                          price_level: int, variance_percent: Decimal,
                          reason: str = None):
        """
