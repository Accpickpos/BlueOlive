...
class LineItemCalculationMixin:
    ...
    @classmethod
    def calculate_line_totals(cls, quantity, unit_price, discount_percentage=Decimal('0.00'), 
                             tax_code=1, cost_price=Decimal('0.00')):
        """
    ...
    @classmethod
    def validate_line_item(cls, quantity, unit_price, discount_percentage=Decimal('0.00')):
        """
