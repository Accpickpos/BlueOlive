...
from apps.stock_control.models import StockItem, StockCategory
...
from .models import (
    ...
    ReceiptOnAccount, CreditNote, CreditNoteLine, CashReturn, CashReturnLine,
    CashACheque, TransactionQuery, Payout
)
from .services import CashSaleService, LaybyeService, QuotationService
from .calculation_service import CalculationService
from .exceptions import InvalidDocumentState, InsufficientStock, POSValidationException
...
class LaybyeServiceTestCase(TransactionTestCase):
    ...
    def test_make_payment_on_laybye(self):
        ...
        payment = LaybyeService.make_payment(
            laybye,
            Decimal('300.00'),
            self.sales_area
        )
