    ...
    def handle(self, *args, **options):
        ...
        account, created = GLMast.objects.get_or_create(
            ...
            defaults=dict(
                ...
                drorcr=GLMast.DEBIT_CREDIT_CHOICES[1][
                    0
                ],  # 'C' - normal credit balance (liability)
        ...
        self.stdout.write(
            self.style.SUCCESS("RentalSettings GL account mapping updated.")
        )
