...
from apps.settings.models import TaxCode, SalesDepartment
from apps.creditors.models import Creditor
from .models import (
    StockItem, SpecialDeal, FuturePricing, PackBundle, PackBundleIngredient,
    StockTransaction, StockTake, StockTakeItem, ContractPricing
)
...
class PackBundleModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.pack_bundle = PackBundle.objects.create(
            stock_item=self.bundle
        )
    ...
    def test_bundle_total_cost_calculation(self):
        ...
        expected = (Decimal('2.00') * Decimal('10.00')) + (Decimal('1.00') * Decimal('20.00'))
