...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='stockitem',
            index=models.Index(fields=['is_active', 'department'], name='idx_stock_active_dept'),
        ),
        # StockTransaction indexes
        migrations.AddIndex(
            model_name='stocktransaction',
            index=models.Index(fields=['debtor', 'transaction_date'], name='idx_stock_debtor_date'),
        ),
        migrations.AddIndex(
            model_name='stocktransaction',
            index=models.Index(fields=['supplier', 'transaction_date'], name='idx_stock_supplier_date'),
        ),
    ]
