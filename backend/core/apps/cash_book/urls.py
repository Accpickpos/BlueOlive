...
router.register(r'income-categories', views.IncomeCategoryViewSet, basename='income-category')
router.register(r'transactions', views.CashBookTransactionViewSet, basename='transaction')
...
router.register(r'cash-withdrawals', views.CashWithdrawalViewSet, basename='cash-withdrawal')
