    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "days_outstanding",
                    models.IntegerField(default=0, help_text="Days since cheque date"),
                ),
                (
                    "is_stale",
                    models.BooleanField(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["bank_account_number", "-reconciliation_date"],
                        name="bank_reconc_bank_ac_de6575_idx",
                    ),
                    models.Index(
                        fields=["status"], name="bank_reconc_status_a73659_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "account_type",
                    models.CharField(
                        choices=[("CASH", "Cash on Hand"), ("BANK", "Bank Account")],
                        default="CASH",
                        max_length=10,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=50,
                        validators=[
                            apps.cash_book.validators.validate_bank_account_number
                        ],
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=15,
                        validators=[apps.cash_book.validators.validate_positive_amount],
                    ),
                ),
                (
                    "category_id",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="cash_book.bankreconciliation",
                    ),
                ),
            ],
            options={
