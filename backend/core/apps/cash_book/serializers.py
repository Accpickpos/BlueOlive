...
class CashBookTransactionSerializer(serializers.ModelSerializer):
    ...
    def get_gl_account(self, obj):
        ...
        gl_accounts = {1: "1100", 2: "2000", 3: "2100", 4: "4000"}
...
class CreateOtherIncomeSerializer(serializers.Serializer):
    ...
    bank_recon_tag = serializers.ChoiceField(
        choices=["R", "P", "D", "U"], default="U", required=False
    )
...
class OtherExpenseSerializer(serializers.ModelSerializer):
    ...
    category_name = serializers.CharField(
        source="expense_category.name", read_only=True
    )
...
class CreateOtherExpenseSerializer(serializers.Serializer):
    ...
    petty_cash_slip_number = serializers.CharField(
...
class BankDepositSerializer(serializers.ModelSerializer):
    transaction = CashBookTransactionSerializer(read_only=True)
    calculated_cash_total = serializers.DecimalField(
...
class CreateBankDepositSerializer(serializers.Serializer):
    ...
    deposit_slip_number = serializers.CharField(
        max_length=50, required=False, allow_blank=True
    )
    ...
    total_incl_vat = serializers.DecimalField(max_digits=12, decimal_places=2)
    audit_type = serializers.IntegerField(
        default=1, help_text="1 = Accounts Receivable"
    )
    category_id = serializers.IntegerField(required=False, allow_null=True)
...
class CreateCashWithdrawalSerializer(serializers.Serializer):
    ...
    total_incl_vat = serializers.DecimalField(max_digits=12, decimal_places=2)
    withdrawal_slip_number = serializers.CharField(
        max_length=50, required=False, allow_blank=True
    )
...
class CreateBankTransferSerializer(serializers.Serializer):
    ...
    transfer_fee = serializers.DecimalField(
        max_digits=15, decimal_places=2, default=0, required=False
    )
...
class CreateBankReconciliationSerializer(serializers.Serializer):
    ...
    closing_balance_per_statement = serializers.DecimalField(
        max_digits=15, decimal_places=2
    )
    closing_balance_per_books = serializers.DecimalField(
        max_digits=15, decimal_places=2
    )
...
class CashFloatSerializer(serializers.ModelSerializer):
    ...
    calculated_counted_cash = serializers.DecimalField(
        max_digits=15, decimal_places=2, read_only=True
    )
...
class ExpenseCategoryBalanceSerializer(serializers.ModelSerializer):
    monthly_balances = serializers.SerializerMethodField(read_only=True)
    year_to_date_balance = serializers.DecimalField(
...
class UpdateExpenseCategoryBalanceSerializer(serializers.Serializer):
    ...
    balance_month_to_date = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    input_vat_month_to_date = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )

    balance_month_01 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    balance_month_02 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    balance_month_03 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    balance_month_04 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    balance_month_05 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    balance_month_06 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    balance_month_07 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    balance_month_08 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    balance_month_09 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    balance_month_10 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    balance_month_11 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
    balance_month_12 = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
...
class UpdateIncomeCategoryBalanceSerializer(serializers.Serializer):
    ...
    output_vat_month_to_date = serializers.DecimalField(
        max_digits=10, decimal_places=2, required=False
    )
