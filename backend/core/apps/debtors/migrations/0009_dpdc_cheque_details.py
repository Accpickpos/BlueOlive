...
def migrate_status_backward(apps, schema_editor):
    Dpdc = apps.get_model('debtors', 'Dpdc')
    new_to_old = {'OUTSTANDING': 'A', 'RECEIVED': 'A', 'CLEARED': 'P', 'DISHONOURED': 'C'}
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='dpdc',
            name='cheque_number',
            field=models.CharField(blank=True, help_text='Cheque number', max_length=30),
        ),
        migrations.AddField(
            model_name='dpdc',
            name='bank',
        ...
        migrations.AddField(
            model_name='dpdc',
            name='received_date',
            field=models.DateField(blank=True, help_text='Date the cheque was received/banked', null=True),
        ),
        migrations.AddField(
            model_name='dpdc',
            name='cleared_date',
            field=models.DateField(blank=True, help_text='Date the cheque cleared', null=True),
        ),
        migrations.AddField(
            model_name='dpdc',
            name='notes',
