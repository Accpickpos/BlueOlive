    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('', 'Balance Brought Forward'), ('O', 'Open Item'), ('C', 'Cash Customer'), ('N', 'Normal Credit'), ('B', 'COD')], db_column='acctype', default='', help_text='Account Type (ACCTYPE) - Blank=Balance Forward, O=Open Item, C=Cash, N=Normal, B=COD', max_length=1)),
