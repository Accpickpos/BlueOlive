    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('dno', models.PositiveIntegerField(db_index=True, help_text='Debtor Account Number (DNO) - Numeric 5', unique=True)),
                ('dname', models.CharField(help_text='Debtors Name (DNAME) - Character 40', max_length=40)),
                ('dsname', models.CharField(db_index=True, help_text='Short/Sort Name (DSNAME) - Character 5', max_length=5)),
                ('dcontact', models.CharField(blank=True, help_text='Contact Person (DCONTACT) - Character 20', max_length=20)),
                ('dtel', models.CharField(blank=True, help_text='Telephone # (DTEL) - Character 15', max_length=15)),
                ('dfax', models.CharField(blank=True, help_text='Fax # (DFAX) - Character 15', max_length=15)),
                ('dadd1', models.CharField(blank=True, help_text='Postal Address Line 1 (DADD1) - Character 25', max_length=25)),
                ('dadd2', models.CharField(blank=True, help_text='Postal Address Line 2 (DADD2) - Character 25', max_length=25)),
                ('dadd3', models.CharField(blank=True, help_text='Postal Address Line 3 (DADD3) - Character 25', max_length=25)),
                ('dpcode', models.CharField(blank=True, help_text='Postal Code (DPCODE) - Character 4', max_length=4)),
                ('delad1', models.CharField(blank=True, help_text='Delivery Address Line 1 (DELAD1) - Character 25', max_length=25)),
                ('delad2', models.CharField(blank=True, help_text='Delivery Address Line 2 (DELAD2) - Character 25', max_length=25)),
                ('delad3', models.CharField(blank=True, help_text='Delivery Address Line 3 (DELAD3) - Character 25', max_length=25)),
                ('delad4', models.CharField(blank=True, help_text='Delivery Address Line 4 (DELAD4) - Character 25', max_length=25)),
                ('dtaxno', models.CharField(blank=True, help_text='Tax No. (DTAXNO) - Character 20', max_length=20)),
                ('darea', models.PositiveIntegerField(default=0, help_text='Salesman/Area # (DAREA) - Numeric 2', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(99)])),
                ('acctype', models.CharField(choices=[('', 'Balance Brought Forward'), ('O', 'Open Item'), ('C', 'Cash Customer')], default='', help_text='Account Category/Type (ACCTYPE) - Blank=Balance Forward, O=Open Item, C=Cash', max_length=1)),
                ('price', models.PositiveIntegerField(default=1, help_text='Price Level (PRICE) - Numeric 1 (1, 2, or 3)', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(3)])),
                ('terms', models.PositiveIntegerField(default=30, help_text='Payment Terms (TERMS) - Numeric 3 (in days)', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(999)])),
                ('ddiscper', models.DecimalField(decimal_places=2, default=0, help_text='Discount % (DDISCPER) - Numeric 10.2', max_digits=10, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('pdisc', models.DecimalField(decimal_places=2, default=0, help_text='Prompt Discount (PDISC) - Numeric 6.2', max_digits=6, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('discprn', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], default='N', help_text='Print Discount on Invoice (DISCPRN) - Character 1', max_length=1)),
                ('dclimit', models.DecimalField(decimal_places=2, default=0, help_text='Credit Limit (DCLIMIT) - Numeric 12.2', max_digits=12, validators=[django.core.validators.MinValueValidator(0)])),
                ('dintflag', models.CharField(choices=[('Y', 'Yes - Charge Interest'), ('N', 'No - Do Not Charge')], default='N', help_text='Charge Interest Y/N (DINTFLAG) - Character 1', max_length=1)),
                ('blockflag', models.CharField(choices=[('Y', 'Blocked'), ('N', 'Active')], default='N', help_text='Block Account (BLOCKFLAG) - Character 1', max_length=1)),
                ('dposbal', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], default='Y', help_text='Print Account Balance on POS (DPOSBAL) - Character 1', max_length=1)),
                ('dbalbfwd', models.DecimalField(decimal_places=2, default=0, help_text='Balance B/F from Previous Month (DBALBFWD) - Numeric 10.2', max_digits=10)),
                ('dcrnt', models.DecimalField(decimal_places=2, default=0, help_text='Current Balance (DCRNT) - Numeric 10.2', max_digits=10)),
                ('d30', models.DecimalField(decimal_places=2, default=0, help_text='30 Day Balance (D30) - Numeric 10.2', max_digits=10)),
                ('d60', models.DecimalField(decimal_places=2, default=0, help_text='60 Day Balance (D60) - Numeric 10.2', max_digits=10)),
                ('d90', models.DecimalField(decimal_places=2, default=0, help_text='90 Day Balance (D90) - Numeric 10.2', max_digits=10)),
                ('d120', models.DecimalField(decimal_places=2, default=0, help_text='120 Day Balance (D120) - Numeric 10.2', max_digits=10)),
                ('d150', models.DecimalField(decimal_places=2, default=0, help_text='150 Day Balance (D150) - Numeric 10.2', max_digits=10)),
                ('d180', models.DecimalField(decimal_places=2, default=0, help_text='180 Day Balance (D180) - Numeric 10.2', max_digits=10)),
                ('dsalesm', models.DecimalField(decimal_places=2, default=0, help_text='Sales Total for Month (DSALESM) - Numeric 10.2', max_digits=10)),
                ('dsalesy', models.DecimalField(decimal_places=2, default=0, help_text='Sales Total for Year (DSALESY) - Numeric 10.2', max_digits=10)),
                ('dprofitm', models.DecimalField(decimal_places=2, default=0, help_text='Profit for Month (DPROFITM) - Numeric 10.2', max_digits=10)),
                ('dprofity', models.DecimalField(decimal_places=2, default=0, help_text='Profit for Year (DPROFITY) - Numeric 10.2', max_digits=10)),
                ('damtlpd', models.DecimalField(decimal_places=2, default=0, help_text='Amount Last Paid (DAMTLPD) - Numeric 10.2', max_digits=10)),
                ('ddatlpd', models.DateField(blank=True, help_text='Date Last Paid (DDATLPD) - Date 8', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('dtrano', models.CharField(db_index=True, help_text='Transaction # (DTRANO) - Numeric 6', max_length=6)),
                ('dtype', models.CharField(choices=[('IN', 'Invoice'), ('CN', 'Credit Note'), ('CS', 'Cash Sale'), ('CR', 'Cash Return'), ('RCP', 'Receipt'), ('INT', 'Interest Charge'), ('JD', 'Journal Debit'), ('JC', 'Journal Credit')], help_text='Transaction Type (DTYPE) - Character 3', max_length=3)),
                ('dtdate', models.DateField(db_index=True, help_text='Transaction Date (DTDATE) - Date 8')),
                ('time', models.TimeField(blank=True, help_text='Transaction Time (TIME) - Character 8 (HH:MM:SS)', null=True)),
                ('dtsub', models.DecimalField(decimal_places=2, help_text='Total Excl. VAT (DTSUB) - Numeric 12.2', max_digits=12)),
                ('dtgst', models.DecimalField(decimal_places=2, default=0, help_text='VAT (DTGST) - Numeric 12.2', max_digits=12)),
                ('dttot', models.DecimalField(decimal_places=2, help_text='Transaction Total (DTTOT) - Numeric 12.2', max_digits=12)),
                ('dtaxstat', models.CharField(choices=[('S', 'Taxable'), ('E', 'Exempt'), ('Z', 'Zero Rated')], default='S', help_text='VAT Status (DTAXSTAT) - Character 1', max_length=1)),
                ('source', models.PositiveIntegerField(default=0, help_text='Station No. (SOURCE) - Numeric 2', validators=[django.core.validators.MaxValueValidator(99)])),
                ('ordno', models.CharField(blank=True, help_text='Order # (ORDNO) - Character 10', max_length=10)),
                ('custref', models.CharField(blank=True, help_text='Customer Ref (CUSTREF) - Character 10', max_length=10)),
                ('del1', models.CharField(blank=True, help_text='Delivery Details Line 1 (DEL1) - Character 25', max_length=25)),
                ('del2', models.CharField(blank=True, help_text='Delivery Details Line 2 (DEL2) - Character 25', max_length=25)),
                ('del3', models.CharField(blank=True, help_text='Delivery Details Line 3 (DEL3) - Character 25', max_length=25)),
                ('del4', models.CharField(blank=True, help_text='Delivery Details Line 4 (DEL4) - Character 25', max_length=25)),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL)),
                ('dno', models.ForeignKey(help_text='Debtor account number (DNO)', on_delete=django.db.models.deletion.PROTECT, related_name='debtran_transactions', to='debtors.debtor')),
                ('updated_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='debtor',
            index=models.Index(fields=['dsname'], name='debtors_deb_dsname_364626_idx'),
        ),
        migrations.AddIndex(
            model_name='debtor',
            index=models.Index(fields=['darea'], name='debtors_deb_darea_4ea229_idx'),
        ),
        migrations.AddIndex(
            model_name='debtor',
        ...
        migrations.AddIndex(
            model_name='debtor',
            index=models.Index(fields=['blockflag'], name='debtors_deb_blockfl_94b1ea_idx'),
        ),
        migrations.AddIndex(
            model_name='debtopen',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['dno', 'dtdate'], name='debtors_deb_dno_id_4dc16d_idx'),
        ),
        migrations.AddIndex(
            model_name='debtortransaction',
            index=models.Index(fields=['dtype', 'dtdate'], name='debtors_deb_dtype_2a015c_idx'),
        ),
        migrations.AddIndex(
            model_name='debtortransaction',
            index=models.Index(fields=['dtdate'], name='debtors_deb_dtdate_106bc0_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='debtortransaction',
