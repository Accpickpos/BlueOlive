...
class DebtorAdmin(admin.ModelAdmin):
    ...
    list_display = ["dno", "dname", "dcrnt", "dclimit", "is_active"]
    list_filter = ["blockflag", "dintflag", "acctype", "is_active", "created_at"]
    ...
    fieldsets = (
        ...
        ("Contact Details", {"fields": ("dtel", "dtel2", "dfax")}),
        (
            "Postal Address",
            {"fields": ("dadd1", "dadd2", "dadd3", "dpcode"), "classes": ("collapse",)},
        ),
        ("Business Details", {"fields": ("darea", "acctype", "price", "terms")}),
        ("Discount & Credit", {"fields": ("ddiscper", "pdisc", "dclimit")}),
        ("Account Control Flags", {"fields": ("blockflag", "dintflag", "dposbal")}),
        (
            "Balance & Aging",
            {
                "fields": (
...
class DebtorTransactionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Status & Metadata", {"fields": ("status", "is_allocated", "created_by")}),
        ("Audit", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
...
class DebtOpenAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Open Item Details", {"fields": ("dno", "dtrano", "type", "date")}),
        ("Amounts", {"fields": ("total", "balancedue", "ageflag")}),
        ("Status", {"fields": ("posted",)}),
        ("Audit", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
...
class DpdcAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Cheque Details", {"fields": ("dno", "date", "amount", "status")}),
        ("Audit", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
...
class DebtorAuditAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Audit Record", {"fields": ("dno", "dtrano", "type", "date", "amount")}),
        ("Details", {"fields": ("thistype", "thistran"), "classes": ("collapse",)}),
    )
...
class DareaAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Area Information", {"fields": ("darea", "dareaname")}),
        (
            "Monthly Sales",
            {
                "fields": (
