...
debtors_router.register(r'transactions', views.DebtorTransactionViewSet, basename='debtor-transaction')
...
debtors_router.register(r'documents', views.DocumentSearchViewSet, basename='document-search')
