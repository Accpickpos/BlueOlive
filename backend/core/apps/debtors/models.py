...
class Debtor(TimeStampedModel):
    ...
    dno = models.IntegerField(unique=True, db_index=True, help_text="Debtor Account Number (DNO) - Numeric 5")
    dname = models.CharField(max_length=100, help_text="Customer/Debtor Name (DNAME) - Character 40")
    dsname = models.CharField(max_length=20, blank=True, db_index=True, help_text="Short/Sort Name (DSNAME) - Character 5")
    dcontact = models.CharField(max_length=50, blank=True, help_text="Contact Person (DCONTACT) - Character 20")
    dtel = models.CharField(max_length=20, blank=True, help_text="Telephone Number (DTEL) - Character 15")
    dtel2 = models.CharField(max_length=20, default='', blank=True, db_column='dtel2', help_text="Alternative Phone (TEL2) - Character 15")
    tel2 = models.CharField(max_length=20, default='', blank=True, db_column='tel2', help_text="Legacy duplicate of dtel2 (TEL2)")
    dfax = models.CharField(max_length=20, blank=True, help_text="Fax Number (DFAX) - Character 15")
    email = models.EmailField(blank=True, db_column='email', help_text="Email Address (EMAIL) - Character 50")
    address_line1 = models.CharField(max_length=100, blank=True, db_column='dadd1', help_text="Postal Address Line 1 (DADD1) - Character 25")
    address_line2 = models.CharField(max_length=100, blank=True, db_column='dadd2', help_text="Postal Address Line 2 (DADD2) - Character 25")
    address_line3 = models.CharField(max_length=100, blank=True, db_column='dadd3', help_text="Postal Address Line 3 (DADD3) - Character 25")
    postal_code = models.CharField(max_length=10, blank=True, db_column='dpcode', help_text="Postal Code (DPCODE) - Character 4")
    delivery_address1 = models.CharField(max_length=100, blank=True, db_column='delad1', help_text="Delivery Address Line 1 (DELAD1) - Character 25")
    delivery_address2 = models.CharField(max_length=100, blank=True, db_column='delad2', help_text="Delivery Address Line 2 (DELAD2) - Character 25")
    delivery_address3 = models.CharField(max_length=100, blank=True, db_column='delad3', help_text="Delivery Address Line 3 (DELAD3) - Character 25")
    delivery_address4 = models.CharField(max_length=100, blank=True, db_column='delad4', help_text="Delivery Address Line 4 (DELAD4) - Character 25")
    dtaxno = models.CharField(max_length=30, blank=True, help_text="Tax/Company Registration Number (DTAXNO) - Character 20")
    vatref = models.CharField(max_length=20, blank=True, help_text="VAT Registration Number (VATREF) - Character 10")
    darea = models.IntegerField(null=True, blank=True, validators=[MinValueValidator(0), MaxValueValidator(99)], help_text="Salesman/Area Number (DAREA) - Numeric 2")
    acctype = models.CharField(max_length=1, choices=ACCOUNT_TYPE_CHOICES, default='', blank=True, help_text="Account Type (ACCTYPE)")
    price = models.IntegerField(default=1, choices=PRICE_LEVEL_CHOICES, validators=[MinValueValidator(1), MaxValueValidator(3)], help_text="Price Level (PRICE) - Numeric 1")
    terms = models.IntegerField(default=30, validators=[MinValueValidator(0), MaxValueValidator(999)], help_text="Payment Terms in Days (TERMS) - Numeric 3")
    ddiscper = models.DecimalField(max_digits=10, decimal_places=2, default=Decimal('0.00'), validators=[MinValueValidator(Decimal('0')), MaxValueValidator(Decimal('100'))], help_text="Standard Discount % (DDISCPER) - Numeric 10.2")
    pdisc = models.DecimalField(max_digits=6, decimal_places=2, default=Decimal('0.00'), validators=[MinValueValidator(Decimal('0')), MaxValueValidator(Decimal('100'))], db_column='pdisc', help_text="Prompt Payment Discount % (PDISC) - Numeric 6.2")
    discount_printable = models.CharField(max_length=1, choices=[('Y', 'Yes'), ('N', 'No')], default='N', db_column='discprn', help_text="Print Discount on Invoice (DISCPRN) - Y/N")
    dclimit = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), validators=[MinValueValidator(Decimal('0'))], help_text="Credit Limit (DCLIMIT) - Numeric 12.2")
    blockflag = models.CharField(max_length=1, choices=BLOCK_FLAG_CHOICES, default='0', help_text="Block Account (BLOCKFLAG)")
    dintflag = models.CharField(max_length=1, choices=INTEREST_FLAG_CHOICES, default='N', help_text="Charge Interest (DINTFLAG) - Y/N")
    dposbal = models.CharField(max_length=1, choices=[('Y', 'Yes'), ('N', 'No')], default='Y', help_text="Print Account Balance on POS (DPOSBAL) - Y/N")
    dbalbfwd = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="Balance Brought Forward (DBALBFWD) - Numeric 10.2")
    dcrnt = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="Current Month Balance (DCRNT) - Numeric 10.2")
    d30 = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="30 Days Balance (D30) - Numeric 10.2")
    d60 = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="60 Days Balance (D60) - Numeric 10.2")
    d90 = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="90 Days Balance (D90) - Numeric 10.2")
    d120 = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="120 Days Balance (D120) - Numeric 10.2")
    d150 = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="150 Days Balance (D150) - Numeric 10.2")
    d180 = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="180+ Days Balance (D180) - Numeric 10.2")
    dsalesm = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="Sales Total for Current Month (DSALESM) - Numeric 10.2")
    dsalesy = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="Sales Total for Year (DSALESY) - Numeric 10.2")
    dprofitm = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="Profit for Current Month (DPROFITM) - Numeric 10.2")
    dprofity = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="Profit for Year (DPROFITY) - Numeric 10.2")
    damtlpd = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), help_text="Amount of Last Payment (DAMTLPD) - Numeric 10.2")
    ddatlpd = models.DateField(null=True, blank=True, help_text="Date of Last Payment (DDATLPD) - Date 8")
    dateopened = models.DateField(null=True, blank=True, help_text="Date Account Opened (DATEOPENED) - Date 8")
    ...
    def save(self, *args, **kwargs):
        ...
        logger.debug(f"[Debtor.save] Before conversion - dtel2={repr(self.dtel2)}, type={type(self.dtel2)}")
    ...
    def total_balance(self):
        return self.dbalbfwd + self.dcrnt + self.d30 + self.d60 + self.d90 + self.d120 + self.d150 + self.d180
    ...
    def get_aged_balance(self, days):
        age_map = {0: self.dcrnt, 30: self.d30, 60: self.d60, 90: self.d90, 120: self.d120, 150: self.d150, 180: self.d180}
...
class DebtorTransactionQuerySet(models.QuerySet):
    ...
    def aging_analysis(self, as_of_date=None):
        ...
        return outstanding.aggregate(
            current=Sum('total_amount', filter=Q(transaction_date__gte=as_of - timedelta(days=30))),
            days_30_60=Sum('total_amount', filter=Q(transaction_date__gte=as_of - timedelta(days=60)) & Q(transaction_date__lt=as_of - timedelta(days=30))),
            days_60_90=Sum('total_amount', filter=Q(transaction_date__gte=as_of - timedelta(days=90)) & Q(transaction_date__lt=as_of - timedelta(days=60))),
            days_90_plus=Sum('total_amount', filter=Q(transaction_date__lt=as_of - timedelta(days=90))),
        )
...
class DebtorTransactionManager(models.Manager):
    ...
    def invoices(self): return self.get_queryset().invoices()
    def payments(self): return self.get_queryset().payments()
    def credits(self): return self.get_queryset().credits()
    def journal_entries(self): return self.get_queryset().journal_entries()
    def interest_charges(self): return self.get_queryset().interest_charges()
    def by_period(self, start_date, end_date): return self.get_queryset().by_period(start_date, end_date)
    def outstanding(self): return self.get_queryset().outstanding()
    def allocated(self): return self.get_queryset().allocated()
    def by_source(self, source): return self.get_queryset().by_source(source)
    def aging_analysis(self, as_of_date=None): return self.get_queryset().aging_analysis(as_of_date)
...
class DebtorTransaction(TimeStampedModel):
    ...
    TRANSACTION_TYPE_CHOICES = [
        ('IN', 'Invoice'), ('CN', 'Credit Note'), ('CS', 'Cash Sale'), ('CR', 'Cash Return'),
        ('PM', 'Payment'), ('RCP', 'Receipt'), ('INT', 'Interest Charge'),
        ('JD', 'Journal Debit'), ('JC', 'Journal Credit'), ('RF', 'Refund'),
    ]
    VAT_STATUS_CHOICES = [('S', 'Standard Rated (15%)'), ('E', 'Exempt'), ('Z', 'Zero Rated')]
    SOURCE_CHOICES = [('POS', 'Point of Sale'), ('INVOICE', 'Invoice Entry'), ('IMPORT', 'Bulk Import'), ('MANUAL', 'Manual Entry')]
    STATUS_CHOICES = [('draft', 'Draft'), ('posted', 'Posted'), ('void', 'Void'), ('reversed', 'Reversed')]
    
    objects = DebtorTransactionManager()
    
    debtor = models.ForeignKey(Debtor, on_delete=models.PROTECT, related_name='transactions', db_column='dno', help_text="Debtor Account Number (DNO)")
    transaction_number = models.CharField(max_length=6, db_index=True, db_column='dtrano', help_text="Transaction Number (DTRANO) - Numeric 6")
    transaction_type = models.CharField(max_length=3, choices=TRANSACTION_TYPE_CHOICES, db_column='dtype', help_text="Transaction Type (DTYPE) - Character 3")
    transaction_date = models.DateField(db_index=True, db_column='dtdate', help_text="Transaction Date (DTDATE) - Date 8")
    transaction_time = models.TimeField(null=True, blank=True, db_column='time', help_text="Transaction Time (TIME)")
    subtotal = models.DecimalField(max_digits=12, decimal_places=2, db_column='dtsub', help_text="Subtotal Excl. VAT (DTSUB)")
    vat_amount = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'), db_column='dtgst', help_text="VAT Amount (DTGST)")
    total_amount = models.DecimalField(max_digits=12, decimal_places=2, db_column='dttot', help_text="Transaction Total Incl. VAT (DTTOT)")
    vat_status = models.CharField(max_length=1, choices=VAT_STATUS_CHOICES, default='S', db_column='dtaxstat', help_text="VAT Status (DTAXSTAT)")
    source_station = models.PositiveIntegerField(default=0, validators=[MaxValueValidator(99)], db_column='source', help_text="Station/Till Number (SOURCE)")
    order_number = models.CharField(max_length=10, blank=True, db_column='ordno', help_text="Order Number (ORDNO)")
    customer_reference = models.CharField(max_length=10, blank=True, db_column='custref', help_text="Customer Reference (CUSTREF)")
    vat_reference = models.CharField(max_length=10, blank=True, db_column='vatref', help_text="VAT Reference (VATREF)")
    station = models.CharField(max_length=5, blank=True, db_column='station', help_text="Station Code (STATION)")
    description_line1 = models.CharField(max_length=100, blank=True, db_column='del1', help_text="Delivery/Description Line 1 (DEL1)")
    description_line2 = models.CharField(max_length=100, blank=True, db_column='del2', help_text="Delivery/Description Line 2 (DEL2)")
    description_line3 = models.CharField(max_length=100, blank=True, db_column='del3', help_text="Delivery/Description Line 3 (DEL3)")
...
class DebtorOpenItem(TimeStampedModel):
    ...
    TRANSACTION_TYPE_CHOICES = [
        ('IN', 'Invoice'), ('CN', 'Credit Note'), ('PY', 'Payment'),
        ('JD', 'Journal Debit'), ('JC', 'Journal Credit'), ('DM', 'Debit Memo'), ('CM', 'Credit Memo'),
    ]
    AGING_CHOICES = [('0', 'Current'), ('1', '30 Days'), ('2', '60 Days'), ('3', '90 Days'), ('4', '120+ Days')]
    
    debtor = models.ForeignKey(Debtor, on_delete=models.CASCADE, related_name='open_items', db_column='dno', help_text="Debtor Number (DNO)")
    transaction_number = models.CharField(max_length=6, db_column='dtrano', help_text="Transaction Number (DTRANO)")
    transaction_type = models.CharField(max_length=2, choices=TRANSACTION_TYPE_CHOICES, db_column='type', help_text="Transaction Type (TYPE)")
    transaction_date = models.DateField(db_index=True, db_column='date', help_text="Transaction Date (DATE)")
    original_amount = models.DecimalField(max_digits=14, decimal_places=2, validators=[MinValueValidator(Decimal('0'))], db_column='total', help_text="Original Transaction Total (TOTAL)")
    balance_due = models.DecimalField(max_digits=14, decimal_places=2, validators=[MinValueValidator(Decimal('0'))], db_column='balancedue', help_text="Current Balance Due (BALANCEDUE)")
    age_flag = models.CharField(max_length=1, choices=AGING_CHOICES, default='0', db_column='ageflag', help_text="Aging Flag (AGEFLAG)")
    posted = models.CharField(max_length=10, default='Y', db_column='posted', help_text="Posted Status (POSTED)")
    ...
    def save(self, *args, **kwargs):
        if not self.due_date and self.debtor and self.transaction_date:
            self.due_date = self.transaction_date + timezone.timedelta(days=getattr(self.debtor, 'terms', 30) or 30)
    ...
    def update_age_flag(self):
        ...
        if days <= 0: self.age_flag = '0'
        elif days <= 30: self.age_flag = '1'
        elif days <= 60: self.age_flag = '2'
        elif days <= 90: self.age_flag = '3'
        else: self.age_flag = '4'
...
class PostDatedCheque(TimeStampedModel):
    ...
    debtor = models.ForeignKey(Debtor, on_delete=models.CASCADE, related_name='post_dated_cheques')
...
class Darea(TimeStampedModel):
    ...
    darea = models.CharField(max_length=2, unique=True, primary_key=True, help_text="Salesman/area number")
    dareaname = models.CharField(max_length=20, help_text="Salesman/area name")
    arsls1 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    arsls2 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    arsls3 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    arsls4 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    arsls5 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    arsls6 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    arsls7 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    arsls8 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    arsls9 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    arsls10 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    arsls11 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    arsls12 = models.DecimalField(max_digits=10, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    ...
    def get_monthly_sales(self):
        return [self.arsls1, self.arsls2, self.arsls3, self.arsls4, self.arsls5, self.arsls6,
                self.arsls7, self.arsls8, self.arsls9, self.arsls10, self.arsls11, self.arsls12]
...
class Debtopen(TimeStampedModel):
    ...
    AGEING_CHOICES = [('0', 'Current'), ('1', '30 Days'), ('2', '60 Days'), ('3', '90 Days'), ('4', '120+ Days')]
    POSTED_CHOICES = [('Y', 'Yes'), ('N', 'No')]
    
    dno = models.ForeignKey(Debtor, on_delete=models.CASCADE, related_name='debtopen_items', help_text="Debtor number (DNO)")
    dtrano = models.CharField(max_length=6, help_text="Transaction number (DTRANO)")
    type = models.CharField(max_length=2, choices=TRANSACTION_TYPE_CHOICES, help_text="Transaction type (TYPE)")
    date = models.DateField(db_index=True, help_text="Date of transaction (DATE)")
    total = models.DecimalField(max_digits=14, decimal_places=2, validators=[MinValueValidator(0)], help_text="Original transaction total (TOTAL)")
    balancedue = models.DecimalField(max_digits=14, decimal_places=2, validators=[MinValueValidator(0)], help_text="Balance due on transaction (BALANCEDUE)")
    ageflag = models.CharField(max_length=1, choices=AGEING_CHOICES, default='0', help_text="Aging flag (AGEFLAG)")
    posted = models.CharField(max_length=10, default='N', help_text="Posted status (POSTED)")
...
class DebtorAudit(models.Model):
    ...
    TRANSACTION_TYPE_CHOICES = [
        ('IN', 'Invoice'), ('CR', 'Credit Note'), ('PA', 'Payment'),
        ('AD', 'Adjustment'), ('DM', 'Debit Memo'), ('CM', 'Credit Memo'), ('AL', 'Allocation'),
    ]
    
    dno = models.ForeignKey(Debtor, on_delete=models.CASCADE, related_name='debtoraud_records', db_column='dno', help_text="Debtor number (DNO)")
    dtrano = models.CharField(max_length=6, db_column='dtrano', help_text="Transaction number (DTRANO)")
    type = models.CharField(max_length=2, choices=TRANSACTION_TYPE_CHOICES, db_column='type', help_text="Transaction type (TYPE)")
    thistype = models.CharField(max_length=2, choices=TRANSACTION_TYPE_CHOICES, db_column='thistype', help_text="Current transaction type (THISTYPE)")
    thistran = models.CharField(max_length=6, db_column='thistran', help_text="Current transaction type identifier (THISTRAN)")
    date = models.DateField(db_index=True, db_column='date', help_text="Audit date (DATE)")
    amount = models.DecimalField(max_digits=12, decimal_places=2, validators=[MinValueValidator(Decimal('0'))], db_column='amount', help_text="Audit amount (AMOUNT)")
    performed_by = models.CharField(max_length=50, blank=True, help_text="User who performed the action")
...
class SalesOrder(TimeStampedModel):
    ...
    STATUS_CHOICES = [('O', 'Outstanding'), ('P', 'Partially Invoiced'), ('I', 'Invoiced'), ('C', 'Cancelled'), ('H', 'On Hold')]
    DELIVERY_OPTION_CHOICES = [('D', 'Delivery'), ('C', 'Collection'), ('M', 'Mail'), ('X', 'Collect Later')]
    ...
    debtor = models.ForeignKey(Debtor, on_delete=models.PROTECT, related_name='sales_orders')
...
class JobCosting(TimeStampedModel):
    ...
    job_number = models.CharField(max_length=6, unique=True, db_index=True, help_text="Job # (6 digits)")
    ...
    odometer_reading = models.DecimalField(max_digits=7, decimal_places=0, null=True, blank=True)
    ...
    salesman_number = models.PositiveIntegerField(null=True, blank=True, validators=[MaxValueValidator(99)])
    station_number = models.PositiveIntegerField(null=True, blank=True, validators=[MaxValueValidator(99)])
    debtor = models.ForeignKey(Debtor, on_delete=models.SET_NULL, null=True, blank=True, related_name='job_costings')
    ...
    transaction_number = models.PositiveIntegerField(null=True, blank=True, validators=[MaxValueValidator(999999)])
...
class JobCostingTransaction(TimeStampedModel):
    ...
    job_costing = models.ForeignKey(JobCosting, on_delete=models.CASCADE, related_name='transactions')
...
class JobPerson(TimeStampedModel):
    ...
    operator_number = models.CharField(max_length=10, unique=True, db_index=True, help_text="Operator number")
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=['operator_number']), models.Index(fields=['operator_name'])]
...
class JobPrinting(TimeStampedModel):
    ...
    station = models.CharField(max_length=2, unique=True, db_index=True, help_text="Station number")
