...
const menuConfig = [
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        base: "/dashboard/admin/purchase_orders",
        icon: Receipt,
        children: [
          { type: "link", name: "Maintenance", href: "/dashboard/admin/purchase_orders/maintenance", icon: FileText },
          { type: "link", name: "Transactions", href: "/dashboard/admin/purchase_orders/transactions", icon: DollarSign },
          { type: "link", name: "Enquiries", href: "/dashboard/admin/purchase_orders/enquiries", icon: Search },
...

  {
    ...
    icon: ShoppingCart,
    children: [
      { type: "link", name: "Dashboard", href: "/dashboard/pos", icon: Home },
      ...
      { type: "link", name: "Laybays", href: "/dashboard/pos/laybays", icon: DollarSign },
